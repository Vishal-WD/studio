...
export default function CreateUserPage() {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      ...
      toast({
        title: 'User Created',
        description: `Successfully created user ${values.username}. You can now log in.`,
      });
      router.push('/login');
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="flex justify-end gap-2 pt-4">
                <Button type="button" variant="ghost" onClick={() => router.push('/login')} disabled={isSubmitting}>
                  Cancel
                </Button>
